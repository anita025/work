...
A responsive React portfolio featuring NetWorthApp, ConctScan, and Bhajan Sarita. Includes project filtering, accessible project dialogs, mobile navigation, and the supplied app images.

## Run

On this computer, double-click `start.cmd` and open the local URL it prints. A local Node.js runtime and installed dependencies are available in this workspace.
...
Create the production site with `npm run build`. Deploy the `dist` directory to any static web host.
